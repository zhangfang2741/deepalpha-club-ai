...
## ✅ 当前状态：1.0 已上架（App Store ID `6806500280`）

**要发新版本请看 `RELEASE.md`**，那是 1.0 之后每版都走的短流程。
本文件保留为首次上架的完整记录（ASC 建 App、配内购、隐私问卷等一次性工作仍以此为准）。

下面这段是 1.0 上架过程中被拒一次的处理记录，已解决，留档备查。

---

## 已解决：被拒（2026-08-31）— 只需改元数据，5 分钟
