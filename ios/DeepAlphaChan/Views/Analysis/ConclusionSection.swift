...
struct ConclusionSection: View {
    ...
    private var formCard: some View {
        ...
        return CollapsibleCard(title: L("形态解读"), systemImage: "text.magnifyingglass",
    ...
    private func recommendationCard(_ rec: Recommendation) -> some View {
        CollapsibleCard(title: L("技术形态倾向"), systemImage: "target",
            ...
            VStack(alignment: .leading, spacing: 14) {
                ...
                if !rec.caveats.isEmpty {
                    ...
                    BulletList(title: L("风险提示"), items: rec.caveats, color: Theme.segment)
                }
            }
        }
    }
