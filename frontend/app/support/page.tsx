      ...
      <div className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="mt-12 space-y-8 text-[15px] leading-7">
          ...
          <Section title="订阅、试用与取消">
            <p>
              订阅分两档，均按月自动续订：<strong>基础版</strong>（¥38/月）解除每日次数限制，
              解锁全量缠论分析与 30 分钟次级别确认；<strong>高级版</strong>（¥188/月）在基础版基础上，
              额外解锁信号雷达、自选批量状态计算。具体价格以 App 内付费墙显示为准（会按你 App Store
              账号所在地区的货币显示）。首次订阅含 3 天免费试用期，试用结束后才开始扣费。
            </p>
            <p className="mt-3">
              取消订阅或在两档之间切换，在<strong>「iPhone 设置 → Apple 账户 → 订阅」</strong>里操作，
              取消需要在当前订阅周期结束前至少 24 小时进行，否则会自动续订下一期。
              取消后当期剩余时间仍可正常使用，到期后回到每日 3 次的免费额度。
            </p>
            <p className="mt-3">
              换了设备或重装 App，在付费墙或「我的」页点<strong>「恢复购买」</strong>即可恢复对应档位的会员身份，
              不需要重新付费。
            </p>
          </Section>
