      ...
      <div className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="mt-12 space-y-8 text-[15px] leading-7">
          ...
          <Section title="订阅、试用与取消">
            <p>
              订阅分两档，均按月自动续订：<strong>体验版</strong>解除每日次数限制，解锁全量缠论分析；
              <strong>高级版</strong>（¥188/月）在体验版基础上，额外解锁信号雷达、30 分钟次级别确认、
              自选批量状态计算。具体价格以 App 内付费墙显示为准（会按你 App Store 账号所在地区的货币显示）。
              首次订阅含 3 天免费试用期，试用结束后才开始扣费。
            </p>
            <p className="mt-3">
